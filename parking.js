class ParkingLot {
  ...
  console.log(parkingLot.park("BG12345AC")); // "BG12345AC is parked successfully"
  setTimeout(() => {
    console.log(parkingLot.leave("BG12345AB")); // "BG12345AB has left the parking lot, fee: 0"
  }, 1000 * 60 * 60);
  setTimeout(() => {
    console.log(parkingLot.leave("BG12345AC")); // "BG12345AC has left the parking lot, fee: 100"
  }, 2 * 1000 * 60 * 60);
